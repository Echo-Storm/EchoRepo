...
SHOWXBMC         = False  # removed from settings
INHERIT          = ADDON.getSetting('INHERIT')          == 'true'
ALPHA_SORT       = False  # removed from settings
LABEL_NUMERIC    = False  # removed from settings
LABEL_NUMERIC_QL = False  # removed from settings
...
FRODO        = False  # Kodi 12 - unsupported, kept for API compatibility
GOTHAM       = False  # Kodi 13 - unsupported
HELIX        = False  # Kodi 14 - unsupported
ISENGARD     = False  # Kodi 15 - unsupported
KRYPTON      = False  # Kodi 17 - unsupported
...
def VerifySettings():
    pass  # migration patches removed with settings they referenced
...
def CleanupKeymaps():
    # Keymap feature removed. Delete any leftover files from previous installs
    # so Kodi stops logging keymap errors on startup.
